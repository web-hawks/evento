...
const Button = ({
  ...
  const variantStyles = {
    ...
    withIcon:
      'text-white bg-light-surfaceDim dark:bg-dark-surfaceBright border border-transparent rounded shadow-sm hover:bg-light-outline dark:hover:bg-dark-outline focus:ring-gray-500 flex justify-center gap-2',
  };
  const sizeStyles = {
